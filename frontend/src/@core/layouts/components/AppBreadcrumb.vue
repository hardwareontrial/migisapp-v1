...
export default {
  ...
  computed: {
    breadCrumbs(){
      if(
        this.$route.name === 'apps-news-detail' ||
        this.$route.name === 'apps-elearning-questions-detail' ||
        this.$route.name === 'apps-elearning-materials-detail' ||
        this.$route.name === 'apps-elearning-materials-edit' || 
        this.$route.name === 'apps-elearning-schedule-detail' ||
        this.$route.name === 'apps-elearning-quiz' ){
  ...
  created(){
    called.$on('appbreadcrumbcustomBreadCrumbs', (val) => { this.customBreadCrumbs = val })
  },
}
</script>
